...
events = {
    ...
    '19,21,23,25,27 Ramadan': 'Nights of Qadr (Revelation of Quran) - Description: These nights are observed as the Nights of Qadr, during which the Quran was revealed to Prophet Muhammad (S.A.W.). They are considered the holiest nights in the Islamic calendar.',
